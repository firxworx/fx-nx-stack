 ...
 *
 * Note: hse of named function (`FormInput`) is compatible with eslint rule requiring component display name in conjunction with `forwardRef`.
 *
...
export const FormInput = React.forwardRef<HTMLInputElement, FormInputProps>(function FormInput(
  { name, label, type = 'text', className, ...props }: FormInputProps,
